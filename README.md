...
- **[EJEMPLOS_API.md](./EJEMPLOS_API.md)** - Ejemplos detallados de todos los endpoints
- **[IMPLEMENTACION_MONGODB.md](./IMPLEMENTACION_MONGODB.md)** - Documentación técnica de la implementación
